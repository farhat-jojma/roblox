...
(function() {
    ...
    s.DisplayObject = function() {
        ...
        var o, a, h, l = 1 / 0,
            ...
            d = -1 / 0,
            p = !1;
        for (n = 0; n < this.children.length; n++) this.children[n].visible && (p = !0, l = l < (o = this.children[n].getBounds()).x ? l : o.x, u = u < o.y ? u : o.y, a = o.width + o.x, h = o.height + o.y, c = c > a ? c : a, d = d > h ? d : h);
        var f = this._bounds;
        if (!p) {
            var g = (f = new s.Rectangle).x,
                ...
                O = b * m + T * y + C,
                I = w * y + _ * m + S;
            c = P, d = E, u = E, l = O < (l = R < (l = A < (l = P) ? A : l) ? R : l) ? O : l, u = I < (u = L < (u = M < u ? M : u) ? L : u) ? I : u, c = O > (c = R > (c = A > c ? A : c) ? R : c) ? O : c, d = I > (d = L > (d = M > d ? M : d) ? L : d) ? I : d
        }
        ...
        if (0 === l && 0 === u) {
            ...
            var x = h * n + u * o + d,
                ...
                S = h * n + u * r + d,
                P = c * r + l * n + p;
            m = S < (m = w < (m = _ < (m = x < m ? x : m) ? _ : m) ? w : m) ? S : m, y = P < (y = C < (y = T < (y = b < y ? b : y) ? T : y) ? C : y) ? P : y, f = S > (f = w > (f = _ > (f = x > f ? x : f) ? _ : f) ? w : f) ? S : f, g = P > (g = C > (g = T > (g = b > g ? b : g) ? T : g) ? C : g) ? P : g
        }
        var E = this._bounds;
            ...
            if (e && (i = e), this.blendMode !== t.currentBlendMode && (t.currentBlendMode = this.blendMode, t.context.globalCompositeOperation = s.blendModesCanvas[t.currentBlendMode]), this._mask && t.maskManager.pushMask(this._mask, t), this.texture.valid) {
                ...
                if (this.texture.rotated) {
                    var c = i.a,
                        ...
                        f = i.d,
                        g = l;
                    a = i.c * u + a, h = i.d * u + h, i.a = 6.123233995736766e-17 * c - p, i.b = 6.123233995736766e-17 * d - f, i.c = c + 6.123233995736766e-17 * p, i.d = d + 6.123233995736766e-17 * f, l = u, u = g
                }
                if (t.roundPixels ? (t.context.setTransform(i.a, i.b, i.c, i.d, 0 | a, 0 | h), r |= 0, o |= 0) : t.context.setTransform(i.a, i.b, i.c, i.d, a, h), r /= n, o /= n, 16777215 !== this.tint)(this.texture.requiresReTint || this.cachedTint !== this.tint) && (this.tintedTexture = s.CanvasTinter.getTintedTexture(this, this.tint), this.cachedTint = this.tint, this.texture.requiresReTint = !1), t.context.drawImage(this.tintedTexture, 0, 0, l, u, r, o, l / n, u / n);
                else {
                    var m = this.texture.crop.x,
                        y = this.texture.crop.y;
                    l = Math.floor(l), u = Math.floor(u), t.context.drawImage(this.texture.baseTexture.source, m, y, l, u, r, o, l / n, u / n)
                }
        ...
        if (s._enableMultiTextureToggle) {
            ...
            for (var u = 0; u < t.length; ++u)
                if ((a = t[u]) in o) {
                    var c = o[a].base;
                    (l -= e(Math.max(c.width, c.height))) <= 0 ? (c.textureIndex = 0, console.warn('setTexturePriority: Image "%s" was given textureIndex=0 because there is no available texture space (%s).', a, l)) : c.textureIndex = 1 + u % (n - 1), this.currentBatchedTextures.push(a)
        ...
        if (a) {
            ...
            if (i.rotated) {
                var S = o.a,
                    ...
                    M = l,
                    R = h;
                T = o.c * C + T, w = o.d * C + w, v = 6.123233995736766e-17 * S - E, x = 6.123233995736766e-17 * P - A, b = S + 6.123233995736766e-17 * E, _ = P + 6.123233995736766e-17 * A, i._updateUvsInverted(), h = u, l = c, u = R, c = M
            }
            var L = this.colors,
                O = this.positions,
                I = t.tint,
                k = (I >> 16) + (65280 & I) + ((255 & I) << 16) + (255 * t.worldAlpha << 24);
            this.renderSession.roundPixels ? (O[g++] = v * l + b * c + T | 0, O[g++] = _ * c + x * l + w | 0, O[g++] = a.x0, O[g++] = a.y0, L[g++] = k, O[g++] = y, O[g++] = v * h + b * c + T | 0, O[g++] = _ * c + x * h + w | 0, O[g++] = a.x1, O[g++] = a.y1, L[g++] = k, O[g++] = y, O[g++] = v * h + b * u + T | 0, O[g++] = _ * u + x * h + w | 0, O[g++] = a.x2, O[g++] = a.y2, L[g++] = k, O[g++] = y, O[g++] = v * l + b * u + T | 0, O[g++] = _ * u + x * l + w | 0, O[g++] = a.x3, O[g++] = a.y3, L[g++] = k, O[g++] = y) : (O[g++] = v * l + b * c + T, O[g++] = _ * c + x * l + w, O[g++] = a.x0, O[g++] = a.y0, L[g++] = k, O[g++] = y, O[g++] = v * h + b * c + T, O[g++] = _ * c + x * h + w, O[g++] = a.x1, O[g++] = a.y1, L[g++] = k, O[g++] = y, O[g++] = v * h + b * u + T, O[g++] = _ * u + x * h + w, O[g++] = a.x2, O[g++] = a.y2, L[g++] = k, O[g++] = y, O[g++] = v * l + b * u + T, O[g++] = _ * u + x * l + w, O[g++] = a.x3, O[g++] = a.y3, L[g++] = k, O[g++] = y), this.sprites[this.currentBatchSize++] = t
        }
        ...
        o.x0 = 0 - l, o.y0 = 0 - u, o.x1 = 1 * c - l, o.y1 = 0 - u, o.x2 = 1 * c - l, o.y2 = 1 * d - u, o.x3 = 0 - l, o.y3 = 1 * d - u;
        var p = t.tint,
            ...
            O = E.tx,
            I = E.ty;
        g[S++] = A * T + R * C + O, g[S++] = L * C + M * T + I, g[S++] = o.x0, g[S++] = o.y0, m[S++] = f, g[S++] = r, g[S++] = A * _ + R * C + O, g[S++] = L * C + M * _ + I, g[S++] = o.x1, g[S++] = o.y1, m[S++] = f, g[S++] = r, g[S++] = A * _ + R * w + O, g[S++] = L * w + M * _ + I, g[S++] = o.x2, g[S++] = o.y2, m[S++] = f, g[S++] = r, g[S++] = A * T + R * w + O, g[S++] = L * w + M * T + I, g[S++] = o.x3, g[S++] = o.y3, m[S++] = f, g[S++] = r, this.sprites[this.currentBatchSize++] = t
        ...
        if (0 !== this.currentBatchSize) {
            ...
            for (var r, o, a, h, l = 0, u = 0, c = null, d = this.renderSession.blendModeManager.currentBlendMode, p = null, f = !1, g = !1, m = 0, y = this.currentBatchSize; m < y; m++) {
                ...
                var v = r.skipRender;
                if (v && h.children.length > 0 && (v = !1), (f || g) && (this.renderBatch(c, l, u), u = m, l = 0, c = r, f && (d = o, this.renderSession.blendModeManager.setBlendMode(d)), g)) {
        ...
        if (e.filterPasses.length > 1) {
            ...
            for (var l = 0; l < e.filterPasses.length - 1; l++) {
                ...
                t.bindFramebuffer(t.FRAMEBUFFER, h.frameBuffer), t.activeTexture(t.TEXTURE0), t.bindTexture(t.TEXTURE_2D, a.texture), this.applyFilterPass(u, i, i.width, i.height);
                var c = a;
                a = h, h = c
            }
        ...
        var x = (i = e._filterArea).x - g,
            b = i.y - m;
        t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffer), this.vertexArray[0] = x, this.vertexArray[1] = b + i.height, this.vertexArray[2] = x + i.width, this.vertexArray[3] = b + i.height, this.vertexArray[4] = x, this.vertexArray[5] = b, this.vertexArray[6] = x + i.width, this.vertexArray[7] = b, t.bufferSubData(t.ARRAY_BUFFER, 0, this.vertexArray), t.bindBuffer(t.ARRAY_BUFFER, this.uvBuffer), this.uvArray[2] = i.width / this.width, this.uvArray[5] = i.height / this.height, this.uvArray[6] = i.width / this.width, this.uvArray[7] = i.height / this.height, t.bufferSubData(t.ARRAY_BUFFER, 0, this.uvArray), t.viewport(0, 0, p * this.renderSession.resolution, f * this.renderSession.resolution), t.bindFramebuffer(t.FRAMEBUFFER, y), t.activeTexture(t.TEXTURE0), t.bindTexture(t.TEXTURE_2D, n.texture), this.renderSession.stencilManager && this.renderSession.stencilManager.destroy(), this.renderSession.stencilManager = e._previous_stencil_mgr, e._previous_stencil_mgr = null, this.renderSession.stencilManager.count > 0 ? t.enable(t.STENCIL_TEST) : t.disable(t.STENCIL_TEST), this.applyFilterPass(d, i, p, f), this.texturePool.push(n), e._glFilterTexture = null
    ...
    return s.FilterTexture = function(t, i, n, r, o) {
        ...
        for (var h = Phaser.Color.hexToRGBArray(e), l = h[0], u = h[1], c = h[2], d = n.getImageData(0, 0, o, a), p = d.data, f = 0; f < p.length; f += 4)
    ...
    function() {
        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), Object.assign || (Object.assign = function(t, e) {
            ...
            extend: function() {
                var t, e, s, n, r, o, a = arguments[0] || {},
                    ...
                    l = arguments.length,
                    u = !1;
                for ("boolean" == typeof a && (u = a, a = arguments[1] || {}, h = 2), l === h && (a = this, --h); h < l; h++)
                    if (null != (t = arguments[h]))
                        for (e in t) s = a[e], a !== (n = t[e]) && (u && n && (i.Utils.isPlainObject(n) || (r = Array.isArray(n))) ? (r ? (r = !1, o = s && Array.isArray(s) ? s : []) : o = s && i.Utils.isPlainObject(s) ? s : {}, a[e] = i.Utils.extend(u, o, n)) : void 0 !== n && (a[e] = n));
                return a
            },
            ...
            var n = t.x,
                ...
                l = t.radius,
                u = a + o * n,
                c = (n * (l * l) - o * (h * h) * (a - r) + h * l * Math.sqrt(h * h * (o * o) + l * l - u * u - r * r + 2 * u * r)) / (h * h * (o * o) + l * l),
                d = (n * (l * l) - o * (h * h) * (a - r) - h * l * Math.sqrt(h * h * (o * o) + l * l - u * u - r * r + 2 * u * r)) / (h * h * (o * o) + l * l),
                p = o * c + a,
                f = o * d + a,
                g = new i.Point(c, p),
                m = new i.Point(d, f),
            ...
            coordinatesOnLine: function(t, e) {
                ...
                for (var c = 1; i !== n || s !== r;) {
                    var d = u << 1;
                    d > -a && (u -= a, i += h), d < o && (u += o, s += l), c % t == 0 && e.push([i, s]), c++
                }
                return e
            },
            clone: function(t) {
            ...
            var a = e.y - t.y,
                ...
                p = a * u - h * l;
            if (0 === p) return null;
            if (o.x = (l * d - u * c) / p, o.y = (h * c - a * d) / p, r) {
            ...
            if (i < o && n >= o) {
                if ((u = s + (r - s) * (o - i) / (n - i)) > a && u <= l) return !0
            } else if (i > h && n <= h && (u = s + (r - s) * (h - i) / (n - i)) >= a && u <= l) return !0;
            if (s < a && r >= a) {
                if ((u = i + (n - i) * (a - s) / (r - s)) >= o && u <= h) return !0
            ...
            var r = n.edges,
                ...
                u = e.bottom,
                c = 1 / 0;
            r[0].setTo(a, h, l, h), r[1].setTo(a, u, l, u), r[2].setTo(a, h, a, u), r[3].setTo(l, h, l, u);
            ...
            for (var a = new i.Rectangle(0, 0, s, n), h = t * s, l = e * n, u = o; u < this.children.length; u++) {
                var c = this.children[u];
                if (c.alignIn)
                    if (c.alignIn(a, r), -1 === t) a.y += n, a.y === l && (a.x += s, a.y = 0);
            ...
            for (var l = 0; l < this.children.length; l++)
                if (this.children[l][t] === e) {
                    if (a++, n && (o ? (o[0] = this.children[l], n.apply(r, o)) : n.call(r, this.children[l])), s === i.Group.RETURN_CHILD) return this.children[l];
            ...
            onMouseOut: function(t) {
                if (this.event = t, this.capture && t.preventDefault(), this.input.mousePointer.withinGame = !1, this.mouseOutCallback && this.mouseOutCallback.call(this.callbackContext, t), this.input.enabled && this.enabled) {
                    ...
                    for (var e in this.input.interactiveItems.list) !0 === this.input.interactiveItems.list[e].enabled && this.input.interactiveItems.list[e]._pointerOutHandler(this.input.mousePointer)
                }
            },
                            ...
                            for (var h = 0; h < this._gamepads.length; h++)
                                if (n = this._gamepads[h], !r.padIndices[h]) {
                                    ...
                                    for (var l = 0; l < this._rawPads.length && !r.padIndices[h]; l++) {
                                        var u = this._rawPads[l];
                                        if (u) {
                                            if (r.rawIndices[u.index]) {
                                                n.disconnect();
                                                continue
                                            }
                                            n.connect(u), r.rawIndices[u.index] = !0, r.padIndices[h] = !0
                                        } else n.disconnect()
                                    }
                                }
                        }
        ...
        i.Component.FixedToCamera = function() {}, i.Component.FixedToCamera.postUpdate = function() {
            ...
            button: function(t, e, s, n, r, o, a, h, l, u) {
                return void 0 === u && (u = this.world), u.add(new i.Button(this.game, t, e, s, n, r, o, a, h, l))
            },
        ...
        return i.Button.prototype.clearFrames = function() {
                ...
                for (var i = this.worldTransform, s = !0, n = 0; n < this.children.length; n++) {
                    ...
                    if (r.visible) {
                        ...
                        if (e.globalAlpha = this.worldAlpha * r.alpha, r.rotation % (2 * Math.PI) == 0) s && (e.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty), s = !1), e.drawImage(o.baseTexture.source, a.x, a.y, a.width, a.height, r.anchor.x * (-a.width * r.scale.x) + r.position.x + .5 + t.shakeX | 0, r.anchor.y * (-a.height * r.scale.y) + r.position.y + .5 + t.shakeY | 0, a.width * r.scale.x, a.height * r.scale.y);
                            ...
                            t.roundPixels ? e.setTransform(h.a, h.b, h.c, h.d, 0 | l, 0 | u) : e.setTransform(h.a, h.b, h.c, h.d, l, u), e.drawImage(o.baseTexture.source, a.x, a.y, a.width, a.height, r.anchor.x * -a.width + .5 | 0, r.anchor.y * -a.height + .5 | 0, a.width, a.height)
                        }
                    }
                }
            }
            ...
            processPixelRGB: function(t, e, s, n, r, o) {
                ...
                for (var a = s + r, h = n + o, l = i.Color.createColor(), u = {
                    ...
                    for (var p = s; p < a; p++) i.Color.unpackPixel(this.getPixel32(p, d), l), !1 !== (u = t.call(e, l, p, d)) && null !== u && void 0 !== u && (this.setPixel32(p, d, u.r, u.g, u.b, u.a, !1), c = !0);
            ...
            processPixel: function(t, e, i, s, n, r) {
                ...
                for (var o = i + n, a = s + r, h = 0, l = 0, u = !1, c = s; c < a; c++)
                    for (var d = i; d < o; d++) h = this.getPixel32(d, c), (l = t.call(e, h, d, c)) !== h && (this.pixels[c * this.width + d] = l, u = !0);
            ...
            replaceRGB: function(t, e, s, n, r, o, a, h, l) {
                ...
                void 0 !== l && l instanceof i.Rectangle && (u = l.x, c = l.y, d = l.width, p = l.height);
                for (var g = 0; g < p; g++)
                    for (var m = 0; m < d; m++) this.getPixel32(u + m, c + g) === f && this.setPixel32(u + m, c + g, r, o, a, h, !1);
            ...
            setHSL: function(t, e, s, n) {
                ...
                if (r || o || a) {
                    ...
                    for (var h = i.Color.createColor(), l = n.y; l < n.bottom; l++)
                        for (var u = n.x; u < n.right; u++) i.Color.unpackPixel(this.getPixel32(u, l), h, !0), r && (h.h = t), o && (h.s = e), a && (h.l = s), i.Color.HSLtoRGB(h.h, h.s, h.l, h), this.setPixel32(u, l, h.r, h.g, h.b, h.a, !1);
                    return this.context.putImageData(this.imageData, 0, 0), this.dirty = !0, this
                }
            },
            ...
            copy: function(t, e, s, n, r, o, a, h, l, u, c, d, p, f, g, m, y) {
                ...
                if (void 0 !== e && null !== e || (e = 0), void 0 !== s && null !== s || (s = 0), n && (this._size.x = n), r && (this._size.y = r), void 0 !== o && null !== o || (o = e), void 0 !== a && null !== a || (a = s), void 0 !== h && null !== h || (h = this._size.x), void 0 !== l && null !== l || (l = this._size.y), "number" == typeof u && (this._rotate = u), "number" == typeof c && (this._anchor.x = c), "number" == typeof d && (this._anchor.y = d), "number" == typeof p && (this._scale.x = p), "number" == typeof f && (this._scale.y = f), "number" == typeof g && (this._alpha.current = g), void 0 === m && (m = null), void 0 === y && (y = !1), !(this._alpha.current <= 0 || 0 === this._scale.x || 0 === this._scale.y || 0 === this._size.x || 0 === this._size.y)) {
                    var v = this.context;
                    return this._alpha.prev = v.globalAlpha, v.save(), v.globalAlpha = this._alpha.current, m && (this.op = m), y && (o |= 0, a |= 0), v.translate(o, a), v.scale(this._scale.x, this._scale.y), v.rotate(this._rotate), v.drawImage(this._image, this._pos.x + e, this._pos.y + s, this._size.x, this._size.y, -h * this._anchor.x, -l * this._anchor.y, h, l), v.restore(), v.globalAlpha = this._alpha.prev, this.dirty = !0, this
                }
            },
            ...
            extract: function(t, e, i, s, n, r, o, a, h) {
                return void 0 === n && (n = 255), void 0 === r && (r = !1), void 0 === o && (o = e), void 0 === a && (a = i), void 0 === h && (h = s), r && t.resize(this.width, this.height), this.processPixelRGB(function(r, l, u) {
                    return r.r === e && r.g === i && r.b === s && t.setPixel32(l, u, o, a, h, n, !1), !1
            ...
            if (n && (o = i.EarCut.eliminateHoles(t, e, o, s)), t.length > 80 * s) {
                h = u = t[0], l = c = t[1];
                for (var g = s; g < r; g += s) d = t[g], p = t[g + 1], d < h && (h = d), p < l && (l = p), d > u && (u = d), p > c && (c = p);
                f = Math.max(u - h, c - l)
            }
            return i.EarCut.earcutLinked(o, a, s, h, l, f), a
        }, i.EarCut.linkedList = function(t, e, s, n, r) {
            var o, a, h, l = 0;
            for (o = e, a = s - n; o < s; o += n) l += (t[a] - t[o]) * (t[o + 1] + t[a + 1]), a = o;
            if (r === l > 0)
            ...
            if (t) {
                ...
                for (var h, l, u = t; t.prev !== t.next;)
                    if (h = t.prev, l = t.next, o ? i.EarCut.isEarHashed(t, n, r, o) : i.EarCut.isEar(t)) e.push(h.i / s), e.push(t.i / s), e.push(l.i / s), i.EarCut.removeNode(t), t = l.next, u = l.next;
                    else if ((t = l) === u) {
            ...
            for (var h = r.x < o.x ? r.x < a.x ? r.x : a.x : o.x < a.x ? o.x : a.x, l = r.y < o.y ? r.y < a.y ? r.y : a.y : o.y < a.y ? o.y : a.y, u = r.x > o.x ? r.x > a.x ? r.x : a.x : o.x > a.x ? o.x : a.x, c = r.y > o.y ? r.y > a.y ? r.y : a.y : o.y > a.y ? o.y : a.y, d = i.EarCut.zOrder(h, l, e, s, n), p = i.EarCut.zOrder(u, c, e, s, n), f = t.nextZ; f && f.z <= p;) {
            ...
            do {
                for (var h = a.next.next; h !== a.prev;) {
                    if (a.i !== h.i && i.EarCut.isValidDiagonal(a, h)) {
                        var l = i.EarCut.splitPolygon(a, h);
                        return a = i.EarCut.filterPoints(a, a.next), l = i.EarCut.filterPoints(l, l.next), i.EarCut.earcutLinked(a, e, s, n, r, o), void i.EarCut.earcutLinked(l, e, s, n, r, o)
                    }
                    h = h.next
                }
                a = a.next
            ...
            var r, o, a, h, l, u = [];
            for (r = 0, o = e.length; r < o; r++) a = e[r] * n, h = r < o - 1 ? e[r + 1] * n : t.length, (l = i.EarCut.linkedList(t, a, h, n, !1)) === l.next && (l.steiner = !0), u.push(i.EarCut.getLeftmost(l));
            for (u.sort(compareX), r = 0; r < u.length; r++) i.EarCut.eliminateHole(u[r], s), s = i.EarCut.filterPoints(s, s.next);
            return s
            ...
            var l, u = s,
                c = 1 / 0;
            for (n = s.next; n !== u;) r >= n.x && n.x >= s.x && i.EarCut.pointInTriangle(o < s.y ? r : a, o, s.x, s.y, o < s.y ? a : r, o, n.x, n.y) && ((l = Math.abs(o - n.y) / (r - n.x)) < c || l === c && n.x > s.x) && i.EarCut.locallyInside(n, t) && (s = n, c = l), n = n.next;
            return s
            ...
            if (t.fill) {
                var h = i.Color.hexToRGBArray(t.fillColor),
                    ...
                    f = e.indices,
                    g = p.length / 6;
                p.push(n, r), p.push(u, c, d, l), p.push(n + o, r), p.push(u, c, d, l), p.push(n, r + a), p.push(u, c, d, l), p.push(n + o, r + a), p.push(u, c, d, l), f.push(g, g, g + 1, g + 2, g + 3, g + 3)
            }
            if (t.lineWidth) {
                var m = t.points;
            ...
            if (l.push(n, r + h), l = l.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n, r + a - h, n, r + a, n + h, r + a)), l = l.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + o - h, r + a, n + o, r + a, n + o, r + a - h)), l = l.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + o, r + h, n + o, r, n + o - h, r)), l = l.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + h, r, n, r, n, r + h)), t.fill) {
                var u = i.Color.hexToRGBArray(t.fillColor),
                    c = t.fillAlpha,
                    d = u[0] * c,
                    p = u[1] * c,
                    f = u[2] * c,
            ...
            for (var a, h, l, u, c, d, p = [], f = 0, g = 0; g <= 20; g++) a = o(t, i, f = g / 20), h = o(e, s, f), l = o(i, n, f), u = o(s, r, f), c = o(a, l, f), d = o(h, u, f), p.push(c, d);
            return p
            ...
            if (t.fill) {
                var u = i.Color.hexToRGBArray(t.fillColor),
                    ...
                    m = e.indices,
                    y = g.length / 6;
                for (m.push(y), l = 0; l < 41; l++) g.push(o, a, d, p, f, c), g.push(o + Math.sin(h * l) * s, a + Math.cos(h * l) * n, d, p, f, c), m.push(y++, y++);
                m.push(y - 1)
            }
            if (t.lineWidth) {
                var v = t.points;
                for (t.points = [], l = 0; l < 41; l++) t.points.push(o + Math.sin(h * l) * s, a + Math.cos(h * l) * n);
            ...
            if (0 !== n.length) {
                ...
                var l, u, c, d, p, f, g, m, y, v, x, b, _, T, w, C, S, P, E, A, M, R, L = e.points,
                    O = e.indices,
                    I = n.length / 2,
                    k = n.length,
                    D = L.length / 6,
                    ...
                    N = B[1] * U,
                    X = B[2] * U;
                for (c = n[0], d = n[1], p = n[2], y = -(d - (f = n[3])), v = c - p, y /= R = Math.sqrt(y * y + v * v), v /= R, y *= F, v *= F, L.push(c - y, d - v, G, N, X, U), L.push(c + y, d + v, G, N, X, U), s = 1; s < I - 1; s++) c = n[2 * (s - 1)], d = n[2 * (s - 1) + 1], p = n[2 * s], f = n[2 * s + 1], g = n[2 * (s + 1)], m = n[2 * (s + 1) + 1], y = -(d - f), v = c - p, y /= R = Math.sqrt(y * y + v * v), v /= R, y *= F, v *= F, x = -(f - m), b = p - g, x /= R = Math.sqrt(x * x + b * b), b /= R, S = (-y + c) * (-v + f) - (-y + p) * (-v + d), A = (-(x *= F) + g) * (-(b *= F) + f) - (-x + p) * (-b + m), M = (w = -v + d - (-v + f)) * (E = -x + p - (-x + g)) - (P = -b + m - (-b + f)) * (C = -y + p - (-y + c)), Math.abs(M) < .1 ? (M += 10.1, L.push(p - y, f - v, G, N, X, U), L.push(p + y, f + v, G, N, X, U)) : ((l = (C * A - E * S) / M) - p) * (l - p) + ((u = (P * S - w * A) / M) - f) + (u - f) > 19600 ? (_ = y - x, T = v - b, _ /= R = Math.sqrt(_ * _ + T * T), T /= R, _ *= F, T *= F, L.push(p - _, f - T), L.push(G, N, X, U), L.push(p + _, f + T), L.push(G, N, X, U), L.push(p - _, f - T), L.push(G, N, X, U), k++) : (L.push(l, u), L.push(G, N, X, U), L.push(p - (l - p), f - (u - f)), L.push(G, N, X, U));
                for (c = n[2 * (I - 2)], d = n[2 * (I - 2) + 1], p = n[2 * (I - 1)], y = -(d - (f = n[2 * (I - 1) + 1])), v = c - p, y /= R = Math.sqrt(y * y + v * v), v /= R, y *= F, v *= F, L.push(p - y, f - v), L.push(G, N, X, U), L.push(p + y, f + v), L.push(G, N, X, U), O.push(D), s = 0; s < k; s++) O.push(D++);
                O.push(D - 1)
            }
            ...
            if (!(s.length < 6)) {
                ...
                for (var r, o, a = 1 / 0, h = -1 / 0, l = 1 / 0, u = -1 / 0, c = 0; c < s.length; c += 2) r = s[c], o = s[c + 1], a = r < a ? r : a, h = r > h ? r : h, l = o < l ? o : l, u = o > u ? o : u;
                s.push(a, l, h, l, h, u, a, u);
                var d = s.length / 2;
            ...
            if (!(s.length < 6)) {
                ...
                for (f = 0; f < o; f++) n.push(s[2 * f], s[2 * f + 1], l, u, c, h);
                return !0
            }
            ...
            for (var n = 0; n < t.graphicsData.length; n++) {
                ...
                if (e.lineWidth = r.lineWidth, r.type === i.POLYGON) {
                    ...
                    o.closed && e.lineTo(l[0], l[1]), l[0] === l[l.length - 2] && l[1] === l[l.length - 1] && e.closePath(), r.fill && (e.globalAlpha = r.fillAlpha * s, e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6), e.fill()), r.lineWidth && (e.globalAlpha = r.lineAlpha * s, e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), e.stroke())
                    ...
                    var g = c / 2 * .5522848,
                        ...
                        x = p + c / 2,
                        b = f + d / 2;
                    e.moveTo(p, b), e.bezierCurveTo(p, b - m, x - g, f, x, f), e.bezierCurveTo(x + g, f, y, b - m, y, b), e.bezierCurveTo(y, b + m, x + g, v, x, v), e.bezierCurveTo(x - g, v, p, b + m, p, b), e.closePath(), r.fill && (e.globalAlpha = r.fillAlpha * s, e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6), e.fill()), r.lineWidth && (e.globalAlpha = r.lineAlpha * s, e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), e.stroke())
                    ...
                    var _ = o.x,
                        ...
                        S = o.radius,
                        P = Math.min(w, C) / 2 | 0;
                    S = S > P ? P : S, e.beginPath(), e.moveTo(_, T + S), e.lineTo(_, T + C - S), e.quadraticCurveTo(_, T + C, _ + S, T + C), e.lineTo(_ + w - S, T + C), e.quadraticCurveTo(_ + w, T + C, _ + w, T + C - S), e.lineTo(_ + w, T + S), e.quadraticCurveTo(_ + w, T, _ + w - S, T), e.lineTo(_ + S, T), e.quadraticCurveTo(_, T, _, T + S), e.closePath(), (r.fillColor || 0 === r.fillColor) && (e.globalAlpha = r.fillAlpha * s, e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6), e.fill()), r.lineWidth && (e.globalAlpha = r.lineAlpha * s, e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), e.stroke())
                }
            }
                ...
                for (var n = 0; n < s; n++) {
                    ...
                    if (r.type === i.POLYGON) {
                        ...
                        var x = o.x,
                            ...
                            w = o.radius,
                            C = Math.min(_, T) / 2 | 0;
                        w = w > C ? C : w, e.moveTo(x, b + w), e.lineTo(x, b + T - w), e.quadraticCurveTo(x, b + T, x + w, b + T), e.lineTo(x + _ - w, b + T), e.quadraticCurveTo(x + _, b + T, x + _, b + T - w), e.lineTo(x + _, b + w), e.quadraticCurveTo(x + _, b, x + _ - w, b), e.lineTo(x + w, b), e.quadraticCurveTo(x, b, x, b + w), e.closePath()
                    }
                }
            }
            ...
            for (var a = o[o.length - 2], h = o[o.length - 1], l = 0, u = 1; u <= 20; ++u) n = a + (t - a) * (l = u / 20), r = h + (e - h) * l, o.push(n + (t + (i - t) * l - n) * l, r + (e + (s - e) * l - r) * l);
            return this.dirty = !0, this._boundsDirty = !0, this
        }, i.Graphics.prototype.bezierCurveTo = function(t, e, i, s, n, r) {
            this.currentPath ? 0 === this.currentPath.shape.points.length && (this.currentPath.shape.points = [0, 0]) : this.moveTo(0, 0);
            for (var o, a, h, l, u, c = this.currentPath.shape.points, d = c[c.length - 2], p = c[c.length - 1], f = 0, g = 1; g <= 20; ++g) h = (a = (o = 1 - (f = g / 20)) * o) * o, u = (l = f * f) * f, c.push(h * d + 3 * a * f * t + 3 * o * l * i + u * n, h * p + 3 * a * f * e + 3 * o * l * s + u * r);
            return this.dirty = !0, this._boundsDirty = !0, this
            ...
            if (c < 1e-8 || 0 === n) r[r.length - 2] === t && r[r.length - 1] === e || r.push(t, e);
                ...
                var d = a * a + h * h,
                    ...
                    w = u * (g + v),
                    C = l * (g + v),
                    S = Math.atan2(T - b, _ - x),
                    P = Math.atan2(C - b, w - x);
                this.arc(x + t, b + e, n, S, P, h * l > u * a)
            }
            return this.dirty = !0, this._boundsDirty = !0, this
            ...
            for (var c = this.currentPath.shape.points, d = a / (2 * h), p = 2 * d, f = Math.cos(d), g = Math.sin(d), m = h - 1, y = m % 1 / m, v = 0; v <= m; v++) {
                var x = d + s + p * (v + y * v),
                    b = Math.cos(x),
                    _ = -Math.sin(x);
                c.push((f * b + g * _) * i + t, (f * -_ + g * b) * i + e)
            }
            return this.dirty = !0, this._boundsDirty = !0, this
            ...
            var e = this._localBounds,
                ...
                C = f,
                S = g;
            return C = m < C ? m : C, C = v < C ? v : C, C = b < C ? b : C, S = y < S ? y : S, S = x < S ? x : S, S = _ < S ? _ : S, T = m > T ? m : T, T = v > T ? v : T, T = b > T ? b : T, w = y > w ? y : w, w = x > w ? x : w, w = _ > w ? _ : w, this._bounds.x = C, this._bounds.width = T - C, this._bounds.y = S, this._bounds.height = w - S, this._currentBounds = this._bounds, this._currentBounds
            ...
            if (this.graphicsData.length)
                for (var r, o, a, h, l, u, c = 0; c < this.graphicsData.length; c++) {
                    var d = this.graphicsData[c],
                        p = d.type,
                        f = d.lineWidth;
                    if (r = d.shape, p === i.RECTANGLE || p === i.ROUNDEDRECTANGLE) a = r.x - f / 2, h = r.y - f / 2, l = r.width + f, u = r.height + f, t = a < t ? a : t, e = a + l > e ? a + l : e, s = h < s ? h : s, n = h + u > n ? h + u : n;
                    else if (p === i.CIRCLE) a = r.x, h = r.y, l = r.radius + f / 2, u = r.radius + f / 2, t = a - l < t ? a - l : t, e = a + l > e ? a + l : e, s = h - u < s ? h - u : s, n = h + u > n ? h + u : n;
                    else if (p === i.ELLIPSE) a = r.x, h = r.y, l = r.width + f / 2, u = r.height + f / 2, t = a - l < t ? a - l : t, e = a + l > e ? a + l : e, s = h - u < s ? h - u : s, n = h + u > n ? h + u : n;
                    else {
                        o = r.points;
            ...
            if (void 0 === e && (e = 100), void 0 === s && (s = 100), void 0 === n && (n = ""), void 0 === r && (r = i.scaleModes.DEFAULT), void 0 === o && (o = 1), void 0 === a && (a = PIXI.defaultRenderer), void 0 === h && (h = 0), this.game = t, this.key = n, this.type = i.RENDERTEXTURE, this._tempMatrix = new i.Matrix, this.width = e, this.height = s, this.resolution = o, this.frame = new i.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution), this.crop = this.frame.clone(), this.baseTexture = new PIXI.BaseTexture, this.baseTexture.width = this.width * this.resolution, this.baseTexture.height = this.height * this.resolution, this.baseTexture._glTextures = [], this.baseTexture.resolution = this.resolution, this.baseTexture.scaleMode = r, this.baseTexture.hasLoaded = !0, PIXI.Texture.call(this, this.baseTexture, this.frame.clone()), this.renderer = a, this.renderer.type === i.WEBGL) {
                ...
                this.baseTexture.textureIndex = h, this.baseTexture._dirty[l.id] = !1, this.textureBuffer = new PIXI.FilterTexture(l, this.width, this.height, this.baseTexture.scaleMode, h), this.baseTexture._glTextures[l.id] = this.textureBuffer.texture, this.projection = new i.Point(.5 * this.width, .5 * -this.height)
            ...
            e = e || 0, s = s || 0, n = void 0 === n || null === n ? "" : n.toString(), this.canvas = i.CanvasPool.create(this), i.Sprite.call(this, t, e, s, PIXI.Texture.fromCanvas(this.canvas)), this.type = i.TEXT, this.physicsType = i.SPRITE, this.padding = new i.Point, this.textBounds = null, this.context = this.canvas.getContext("2d"), this.colors = [], this.strokeColors = [], this.fontStyles = [], this.fontWeights = [], this.autoRound = !1, this.useAdvancedWrap = !1, this.splitRegExp = /(?:\r\n|\r|\n)/, this.characterLimitSize = -1, this.characterLimitSuffix = "", this._res = t.renderer.resolution, this._text = n, this._fontComponents = null, this._lineSpacing = 0, this._charCount = 0, this._width = 0, this._height = 0, this.style = {}, this.setStyle(r || {}), "" !== n && this.updateText()
            ...
            for (var a = 0; a < o; a++) {
                if (0 === i) {
                    ...
                    this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? l += this.measureLine(e[a]) : l += this.context.measureText(e[a]).width, this.style.wordWrap && (l -= this.context.measureText(" ").width)
                } else {
                    var h = e[a].split(/(?:\t)/),
            ...
            for (var e = this.context, i = this.style.wordWrapWidth, s = "", n = t.replace(/ +/gi, " ").split(/\r?\n/gi), r = n.length, o = 0; o < r; o++) {
                ...
                if (a = a.replace(/^ *|\s*$/gi, ""), e.measureText(a).width < i) s += a + "\n";
                    ...
                    for (var l = i, u = a.split(" "), c = 0; c < u.length; c++) {
                        var d = u[c],
                            p = d + " ",
            ...
            if (!e) {
                ...
                var h, l, u = n.getImageData(0, 0, r, a).data,
                    c = u.length,
                    d = 4 * r,
                    p = 0,
                    f = !1;
            ...
            for (var s = 0, n = 0, r = -1, o = 0, a = null, h = this._maxWidth > 0 ? this._maxWidth : null, l = [], u = 0; u < i.length; u++) {
                var c = u === i.length - 1;
                ...
                if (/(\s)/.test(i.charAt(u)) && (r = u, o = n), f = (g + p.texture.width + p.xOffset) * e, h && n + f >= h && r > -1) return {
                    width: o || n,
                    text: i.substr(0, u - (u - r)),
                    end: !1,
                    chars: l
                };
                n += (p.xAdvance + g) * e, l.push(s + (p.xOffset + g) * e), s += (p.xAdvance + g) * e, a = d
            }
            return {
                width: n,
                text: i,
            ...
            if (t) {
                ...
                for (var r = 0, o = 0, a = this.textWidth * this.anchor.x, h = this.textHeight * this.anchor.y, l = 0; l < s.length; l++) {
                    var u = s[l];
                    "right" === this._align ? o = this.textWidth - u.width : "center" === this._align && (o = (this.textWidth - u.width) / 2);
                    for (var c = 0; c < u.text.length; c++) {
                        var d = u.text.charCodeAt(c),
                            p = t.chars[d];
                        void 0 === p && (d = 32, p = t.chars[d]);
                        var f = this._glyphs[r];
                        f ? f.texture = p.texture : ((f = new PIXI.Sprite(p.texture)).name = u.text[c], this._glyphs.push(f)), f.position.x = u.chars[c] + o - a, f.position.y = u.y + p.yOffset * i - h, f.scale.set(i), f.tint = this.tint, f.texture.requiresReTint = !0, f.cachedTint = 16777215, f.parent || this.addChild(f), r++
                    }
                }
            ...
            void 0 !== o && null !== o || (o = t.cache.getImage(e).width / s), this.characterWidth = s, this.characterHeight = n, this.characterSpacingX = a || 0, this.characterSpacingY = h || 0, this.characterPerRow = o, this.offsetX = l || 0, this.offsetY = u || 0, this.align = "left", this.multiLine = !1, this.autoUpperCase = !0, this.customSpacingX = 0, this.customSpacingY = 0, this.fixedWidth = 0, this.fontSet = t.cache.getImage(e), this._text = "", this.grabData = [], this.frameData = new i.FrameData;
            for (var c = this.offsetX, d = this.offsetY, p = 0, f = 0; f < r.length; f++) {
                var g = this.frameData.addFrame(new i.Frame(f, c, d, this.characterWidth, this.characterHeight));
                this.grabData[r.charCodeAt(f)] = g.index, ++p === this.characterPerRow ? (p = 0, c = this.offsetX, d += this.characterHeight + this.characterSpacingY) : c += this.characterWidth + this.characterSpacingX
            }
            ...
            if (!(t.length < 1)) {
                ...
                this.count -= .2;
                for (var n, r, o, a, h = this.vertices, l = t.length, u = 0; u < l; u++) n = t[u], r = 4 * u, e = u < t.length - 1 ? t[u + 1] : n, s.y = -(e.x - i.x), s.x = e.y - i.y, 10 * (1 - u / (l - 1)) > 1 && 1, o = Math.sqrt(s.x * s.x + s.y * s.y), a = this.texture.height / 2, s.x /= o, s.y /= o, s.x *= a, s.y *= a, h[r] = n.x + s.x, h[r + 1] = n.y + s.y, h[r + 2] = n.x - s.x, h[r + 3] = n.y - s.y, i = n;
                PIXI.DisplayObjectContainer.prototype.updateTransform.call(this)
            }
        }, i.Rope.prototype.setTexture = function(t) {
            this.texture = t
        }, i.Rope.prototype._renderWebGL = function(t) {
        ...
        }, i.Rope.prototype._initWebGL = function(t) {
            var e = t.gl;
        ...
        }, i.Rope.prototype._renderStrip = function(t) {
            var e = t.gl,
                s = t.projection,
                n = t.offset,
                r = t.shaderManager.stripShader,
                o = this.drawMode === i.Rope.TRIANGLE_STRIP ? e.TRIANGLE_STRIP : e.TRIANGLES;
        ...
        }, i.Rope.prototype._renderCanvas = function(t) {
            var e = t.context,
                s = this.worldTransform,
                n = s.tx * t.resolution + t.shakeX,
                r = s.ty * t.resolution + t.shakeY;
            t.roundPixels ? e.setTransform(s.a, s.b, s.c, s.d, 0 | n, 0 | r) : e.setTransform(s.a, s.b, s.c, s.d, n, r), this.drawMode === i.Rope.TRIANGLE_STRIP ? this._renderCanvasTriangleStrip(e) : this._renderCanvasTriangles(e)
        }, i.Rope.prototype._renderCanvasTriangleStrip = function(t) {
            var e = this.vertices,
                i = this.uvs,
                s = e.length / 2;
            this.count++;
        ...
        }, i.Rope.prototype._renderCanvasTriangles = function(t) {
            var e = this.vertices,
                i = this.uvs,
                s = this.indices,
                n = s.length;
        ...
        }, i.Rope.prototype._renderCanvasDrawTriangle = function(t, e, i, s, n, r) {
            ...
            if (this.canvasPadding > 0) {
                var _ = this.canvasPadding / this.worldTransform.a,
                    ...
                    P = d - C,
                    E = Math.sqrt(S * S + P * P);
                l = w + S / E * (E + _), d = C + P / E * (E + T), P = p - C, u = w + (S = u - w) / (E = Math.sqrt(S * S + P * P)) * (E + _), p = C + P / E * (E + T), P = f - C, c = w + (S = c - w) / (E = Math.sqrt(S * S + P * P)) * (E + _), f = C + P / E * (E + T)
            }
            t.save(), t.beginPath(), t.moveTo(l, d), t.lineTo(u, p), t.lineTo(c, f), t.closePath(), t.clip();
            var A = g * x + v * y + m * b - x * y - v * m - g * b,
                M = l * x + v * c + u * b - x * c - v * u - l * b,
                R = g * u + l * y + m * c - u * y - l * m - g * c,
                L = g * x * c + v * u * y + l * m * b - l * x * y - v * m * c - g * u * b,
                O = d * x + v * f + p * b - x * f - v * p - d * b,
                I = g * p + d * y + m * f - p * y - d * m - g * f,
                k = g * x * f + v * p * y + d * m * b - d * x * y - v * m * f - g * p * b;
            t.transform(M / A, O / A, R / A, I / A, L / A, k / A), t.drawImage(o, 0, 0), t.restore()
        }, i.Rope.prototype.renderStripFlat = function(t) {
            var e = this.context,
                i = t.vertices,
                s = i.length / 2;
        ...
        }, i.Rope.prototype.getBounds = function(t) {
            for (var e = t || this.worldTransform, i = e.a, s = e.b, n = e.c, r = e.d, o = e.tx, a = e.ty, h = -1 / 0, l = -1 / 0, u = 1 / 0, c = 1 / 0, d = this.vertices, p = 0; p < d.length; p += 2) {
                var f = d[p],
                    g = d[p + 1],
                    m = i * f + n * g + o,
                    y = r * g + s * f + a;
                u = m < u ? m : u, c = y < c ? y : c, h = m > h ? m : h, l = y > l ? y : l
            }
            if (u === -1 / 0 || l === 1 / 0) return PIXI.EmptyRectangle;
            var v = this._bounds;
            return v.x = u, v.width = h - u, v.y = c, v.height = l - c, this._currentBounds = v, v
            ...
            get: function() {
                for (var t, e, s, n, r, o, a, h, l = [], u = 0; u < this.points.length; u++) t = 4 * u, e = this.vertices[t] * this.scale.x, s = this.vertices[t + 1] * this.scale.y, n = this.vertices[t + 4] * this.scale.x, r = this.vertices[t + 3] * this.scale.y, o = i.Math.difference(e, n), a = i.Math.difference(s, r), e += this.world.x, s += this.world.y, h = new i.Rectangle(e, s, o, a), l.push(h);
                return l
            }
            ...
            if (this.visible && this.renderable && 0 !== this.alpha) {
                ...
                var l = this._width / h.x,
                    u = this._height / h.y;
                t.roundPixels && (n |= 0, r |= 0, l |= 0, u |= 0), e.fillRect(n, r, l, u), e.scale(1 / h.x, 1 / h.y), e.translate(-a.x + this.anchor.x * this._width, -a.y + this.anchor.y * this._height), this._mask && t.maskManager.popMask(t);
            ...
            if (this.texture.baseTexture.hasLoaded) {
                ...
                var h = e.crop.width,
                    l = e.crop.height;
                h === n && l === r || (h = n, l = r);
                var u = this.tintedTexture ? this.tintedTexture : e.baseTexture.source;
                this.canvasBuffer.context.drawImage(u, e.crop.x, e.crop.y, e.crop.width, e.crop.height, o, a, h, l), this.tileScaleOffset.x = s.width / n, this.tileScaleOffset.y = s.height / r, this.refreshTexture = !1, this.tilingTexture.baseTexture._powerOf2 = !0
            }
            ...
            var t = this._width,
                ...
                w = 1 / 0,
                C = 1 / 0;
            w = x < (w = y < (w = g < (w = p < w ? p : w) ? g : w) ? y : w) ? x : w, C = b < (C = v < (C = m < (C = f < C ? f : C) ? m : C) ? v : C) ? b : C, _ = x > (_ = y > (_ = g > (_ = p > _ ? p : _) ? g : _) ? y : _) ? x : _, T = b > (T = v > (T = m > (T = f > T ? f : T) ? m : T) ? v : T) ? b : T;
            var S = this._bounds;
            return S.x = w, S.width = _ - w, S.y = C, S.height = T - C, this._currentBounds = S, S
            ...
            spriteSheet: function(t, e, s, n, r, o, a, h) {
                ...
                var u = l.width,
                    c = l.height;
                s <= 0 && (s = Math.floor(-u / Math.min(-1, s))), n <= 0 && (n = Math.floor(-c / Math.min(-1, n)));
                var d = Math.floor((u - o) / (s + a)) * Math.floor((c - o) / (n + a));
                ...
                if (h < 0 && (h = d + h), -1 !== r && (d = h + r), 0 === u || 0 === c || u < s || c < n || 0 === d) return console.warn("Phaser.AnimationParser.spriteSheet: '" + e + "'s width/height zero or width/height < given frameWidth/frameHeight"), null;
                for (var p = new i.FrameData, f = o, g = o, m = 0; m < d; m++) p.addFrame(new i.Frame(m, f, g, s, n, "")), (f += s + a) + s > u && (f = o, g += n + a);
                return p
            },
            ...
            addBitmapFontFromAtlas: function(t, e, s, n, r, o, a) {
                ...
                if (h) {
                    ...
                    var u;
                    "json" === r ? (u = this.getJSON(n), l.font = i.LoaderParser.jsonBitmapFont(u, l.base, o, a, h, this.game.resolution)) : (u = this.getXML(n), l.font = i.LoaderParser.xmlBitmapFont(u, l.base, o, a, h, this.game.resolution)), this._cache.bitmapFont[t] = l
                }
            },
            ...
            addSpriteSheet: function(t, e, s, n, r, o, a, h, l) {
                ...
                var u = {
                    ...
                    spacing: h,
                    base: new PIXI.BaseTexture(s, null, this.game.resolution),
                    frameData: i.AnimationParser.spriteSheet(this.game, s, n, r, o, a, h, l)
                };
                this._cache.image[t] = u, this._resolveURL(e, u)
            },
            ...
            xmlBitmapFont: function(t, e, i, s, n, r) {
                ...
                for (var l = t.getElementsByTagName("char"), u = n ? n.x : 0, c = n ? n.y : 0, d = 0; d < l.length; d++) {
                    ...
                    o.chars[p] = {
                        x: u + parseInt(l[d].getAttribute("x"), 10),
                        y: c + parseInt(l[d].getAttribute("y"), 10),
            ...
            resume: function() {
                if (this.paused && this._sound) {
                    if (this.usingWebAudio) {
                        ...
                        this._sound = this.context.createBufferSource(), this._sound.buffer = this._buffer, this.externalNode ? this._sound.connect(this.externalNode) : this._sound.connect(this.gainNode), "" === this.currentMarker && (this.loop ? this._sound.loop = !0 : this._sound.onended = this.onEndedHandler.bind(this));
                        var e = this.duration - this.pausedPosition / 1e3;
                        void 0 === this._sound.start ? this._sound.noteGrainOn(0, t, e) : this.loop && this.game.device.chrome ? 42 === this.game.device.chromeVersion ? this._sound.start(0) : "" === this.currentMarker ? this._sound.start(0, t) : this._sound.start(0, t, e) : this._sound.start(0, t, e)
            ...
            boot: function() {
                ...
                } else this.usingWebAudio = !0, void 0 === this.context.createGain ? this.masterGain = this.context.createGainNode() : this.masterGain = this.context.createGain(), this.masterGain.gain.value = 1, this.masterGain.connect(this.context.destination), "suspended" === this.context.state && this.game.input.onUp.addOnce(this.resumeWebAudio, this);
            ...
            unlock: function() {
                ...
                if (this.usingAudioTag) this.setTouchUnlock();
                    ...
                    this._unlockSource = this.context.createBufferSource(), this._unlockSource.buffer = t, this._unlockSource.connect(this.context.destination), void 0 === this._unlockSource.start ? this._unlockSource.noteOn(0) : this._unlockSource.start(0), this.resumeWebAudio()
                }
                return !0
            },
            stopAll: function() {
            ...
            update: function() {
                if (!this.noAudio) {
                    !this.touchLocked || null === this._unlockSource || this._unlockSource.playbackState !== this._unlockSource.PLAYING_STATE && this._unlockSource.playbackState !== this._unlockSource.FINISHED_STATE || (this.setTouchUnlock(), this.resumeWebAudio());
            ...
            getParentBounds: function(t, e) {
                var s = t || new i.Rectangle,
                    n = e || this.boundingParent,
                ...
                if (n) {
                    ...
                    if (l.right) {
                        u = "layout" === l.right ? o : r;
                        s.right = Math.min(s.right, u.width)
                    }
                    if (l.bottom) {
                        var u = "layout" === l.bottom ? o : r;
            ...
            spriteInfo: function(t, e, i, s) {
                this.start(e, i, s), this.line("Sprite: " + (t.name || "") + " (" + t.width + " x " + t.height + ") anchor: " + t.anchor.x + " x " + t.anchor.y), this.line("x: " + t.x.toFixed(1) + " y: " + t.y.toFixed(1)), this.line("angle: " + t.angle.toFixed(1) + " rotation: " + t.rotation.toFixed(1)), this.line("visible: " + t.visible + " in camera: " + t.inCamera), this.line("bounds x: " + t._bounds.x.toFixed(1) + " y: " + t._bounds.y.toFixed(1) + " w: " + t._bounds.width.toFixed(1) + " h: " + t._bounds.height.toFixed(1)), this.stop()
            },
            ...
            interpolateColor: function(t, e, s, n, r, o) {
                ...
                return i.Color.getColor32(r, l, u, c)
            },
            ...
            collideHandler: function(t, e, s, n, r, o) {
                if (void 0 === e && t.physicsType === i.GROUP) return this.sort(t), void this.collideGroupVsSelf(t, s, n, r, o);
                t && e && t.exists && e.exists && (this.sortDirection !== i.Physics.Arcade.SORT_NONE && (t.physicsType === i.GROUP && this.sort(t), e.physicsType === i.GROUP && this.sort(e)), t.physicsType === i.SPRITE ? e.physicsType === i.SPRITE ? this.collideSpriteVsSprite(t, e, s, n, r, o) : e.physicsType === i.GROUP ? this.collideSpriteVsGroup(t, e, s, n, r, o) : e.physicsType === i.TILEMAPLAYER && this.collideSpriteVsTilemapLayer(t, e, s, n, r, o) : t.physicsType === i.GROUP ? e.physicsType === i.SPRITE ? this.collideSpriteVsGroup(e, t, s, n, r, o) : e.physicsType === i.GROUP ? this.collideGroupVsGroup(t, e, s, n, r, o) : e.physicsType === i.TILEMAPLAYER && this.collideGroupVsTilemapLayer(t, e, s, n, r, o) : t.physicsType === i.TILEMAPLAYER && (e.physicsType === i.SPRITE ? this.collideSpriteVsTilemapLayer(e, t, s, n, r, o) : e.physicsType === i.GROUP && this.collideGroupVsTilemapLayer(e, t, s, n, r, o)))
            },
                    ...
                    if (this.skipQuadTree || t.body.skipQuadTree)
                        for (var a = {}, h = 0; h < e.hash.length; h++) {
                            ...
                            if (l && l.exists && l.body) {
                                ...
                                this.collideSpriteVsSprite(t, l, s, n, r, o)
                            }
                        } else {
                            ...
                            for (var u = this.quadTree.retrieve(t), h = 0; h < u.length; h++) this.separate(t.body, u[h], n, r, o) && (s && s.call(r, t, u[h].sprite), this._total++)
                        }
            },
            collideGroupVsSelf: function(t, e, s, n, r) {
                if (0 !== t.length)
                        ...
                        if (h && h.exists && h.body) {
                            ...
                            for (var l = o + 1; l < t.hash.length; l++) {
                                ...
                                if (c && c.exists && c.body) {
                                    if (u = c.body.getBounds(u), this.sortDirection === i.Physics.Arcade.LEFT_RIGHT) {
                                        if (a.right < u.x) break;
                                        if (u.right < a.x) continue
                                    } else if (this.sortDirection === i.Physics.Arcade.RIGHT_LEFT) {
                                        if (a.x > u.right) continue;
                                        if (u.x > a.right) break
                                    } else if (this.sortDirection === i.Physics.Arcade.TOP_BOTTOM) {
                                        if (a.bottom < u.y) continue;
                                        if (u.bottom < a.y) break
                                    } else if (this.sortDirection === i.Physics.Arcade.BOTTOM_TOP) {
                                        if (a.y > u.bottom) continue;
                                        if (u.y > h.body.bottom) break
                                    }
                                    this.collideSpriteVsSprite(h, c, e, s, n, r)
                                }
                            }
                        }
                    }
            },
            collideGroupVsGroup: function(t, e, s, n, r, o) {
                if (0 !== t.length && 0 !== e.length)
                    for (var a = 0; a < t.children.length; a++) t.children[a].exists && (t.children[a].physicsType === i.GROUP ? this.collideGroupVsGroup(t.children[a], e, s, n, r, o) : this.collideSpriteVsGroup(t.children[a], e, s, n, r, o))
            },
            separate: function(t, e, i, s, n) {
                ...
                var l = !1,
                    u = !1;
                this.forceX || Math.abs(this.gravity.y + t.gravity.y) < Math.abs(this.gravity.x + t.gravity.x) ? (l = this.separateX(t, e, n), this.intersects(t, e) && (u = this.separateY(t, e, n))) : (u = this.separateY(t, e, n), this.intersects(t, e) && (l = this.separateX(t, e, n)));
                var c = l || u;
                return c && (n ? (t.onOverlap && t.onOverlap.dispatch(t.sprite, e.sprite), e.onOverlap && e.onOverlap.dispatch(e.sprite, t.sprite)) : (t.onCollide && t.onCollide.dispatch(t.sprite, e.sprite), e.onCollide && e.onCollide.dispatch(e.sprite, t.sprite))), c
            },
            intersects: function(t, e) {
                return t !== e && (t.isCircle ? e.isCircle ? i.Math.distance(t.center.x, t.center.y, e.center.x, e.center.y) <= t.halfWidth + e.halfWidth : this.circleBodyIntersects(t, e) : e.isCircle ? this.circleBodyIntersects(e, t) : !(t.right <= e.position.x) && (!(t.bottom <= e.position.y) && (!(t.position.x >= e.right) && !(t.position.y >= e.bottom))))
            },
            circleBodyIntersects: function(t, e) {
                var s = i.Math.clamp(t.center.x, e.left, e.right),
                    n = i.Math.clamp(t.center.y, e.top, e.bottom);
                return (t.center.x - s) * (t.center.x - s) + (t.center.y - n) * (t.center.y - n) <= t.halfWidth * t.halfWidth
            },
            separateCircle: function(t, e, s) {
                ...
                } else a = t.halfWidth + e.halfWidth - i.Math.distance(t.center.x, t.center.y, e.center.x, e.center.y);
                if (s || 0 === a || t.immovable && e.immovable || t.customSeparateX || e.customSeparateX) return 0 !== a && (t.onOverlap && t.onOverlap.dispatch(t.sprite, e.sprite), e.onOverlap && e.onOverlap.dispatch(e.sprite, t.sprite)), 0 !== a;
                var u = {
            ...
            getObjectsAtLocation: function(t, e, s, n, r, o) {
                ...
                for (var a = new i.Rectangle(t, e, 1, 1), h = [], l = this.quadTree.retrieve(a), u = 0; u < l.length; u++) l[u].hitTest(t, e) && (n && n.call(r, o, l[u].sprite), h.push(l[u].sprite));
                return h
            },
            moveToObject: function(t, e, s, n) {
                void 0 === s && (s = 60), void 0 === n && (n = 0);
                var r = i.Point.angle(e, t);
                return n > 0 && (s = this.distanceBetween(t, e) / (n / 1e3)), t.body.velocity.setToPolar(r, s), r
            },
            ...
            velocityFromAngle: function(t, e, s) {
                return void 0 === e && (e = 60), (s = s || new i.Point).setToPolar(t, e, !0)
            },
            velocityFromRotation: function(t, e, s) {
                return void 0 === e && (e = 60), (s = s || new i.Point).setToPolar(t, e)
            },
            ...
            distanceBetween: function(t, e, i, s) {
                void 0 === i && (i = !1);
                var n, r;
                return s ? (n = t.centerX - e.centerX, r = t.centerY - e.centerY) : i ? (n = t.world.x - e.world.x, r = t.world.y - e.world.y) : (n = t.x - e.x, r = t.y - e.y), Math.sqrt(n * n + r * r)
            },
            ...
            angleBetween: function(t, e, s) {
                return void 0 === s && (s = !1), s ? i.Point.angle(e.world, t.world) : i.Point.angle(e, t)
            },
            ...
            moveFrom: function(t, e, i) {
                ...
                var s;
                return void 0 === i ? (s = this.angle, i = this.game.math.radToDeg(s)) : s = this.game.math.degToRad(i), this.moveTimer = 0, this.moveDuration = t, 0 === i || 180 === i ? this.velocity.set(Math.cos(s) * e, 0) : 90 === i || 270 === i ? this.velocity.set(0, Math.sin(s) * e) : this.velocity.setToPolar(s, e), this.isMoving = !0, !0
            },
            moveTo: function(t, e, s) {
                var n = e / (t / 1e3);
                if (0 === n) return !1;
                var r;
                return void 0 === s ? (r = this.angle, s = this.game.math.radToDeg(r)) : r = this.game.math.degToRad(s), e = Math.abs(e), this.moveDuration = 0, this.moveDistance = e, null === this.moveTarget && (this.moveTarget = new i.Line, this.moveEnd = new i.Point), this.moveTarget.fromAngle(this.x, this.y, r, e), this.moveEnd.set(this.moveTarget.end.x, this.moveTarget.end.y), this.moveTarget.setTo(this.x, this.y, this.x, this.y), 0 === s || 180 === s ? this.velocity.set(Math.cos(r) * n, 0) : 90 === s || 270 === s ? this.velocity.set(0, Math.sin(r) * n) : this.velocity.setToPolar(r, n), this.isMoving = !0, !0
            },
        ...
        }), i.Physics.Arcade.Body.render = function(t, e, i, s, n) {
            ...
            separateTile: function(t, e, i, s, n) {
                ...
                var a = 0,
                    ...
                    l = 0,
                    u = 1;
                if (e.deltaAbsX() > e.deltaAbsY() ? l = -1 : e.deltaAbsX() < e.deltaAbsY() && (u = -1), 0 !== e.deltaX() && 0 !== e.deltaY() && (i.faceLeft || i.faceRight) && (i.faceTop || i.faceBottom) && (l = Math.min(Math.abs(e.position.x - r - i.right), Math.abs(e.right - r - i.left)), u = Math.min(Math.abs(e.position.y - o - i.bottom), Math.abs(e.bottom - o - i.top))), l < u) {
        ...
        }, i.Utils.mixinPrototype(i.Physics.Arcade.prototype, i.Physics.Arcade.TilemapCollision.prototype), i.ImageCollection = function(t, e, i, s, n, r, o) {
        ...
        }, i.ImageCollection.prototype.constructor = i.ImageCollection, i.Tile = function(t, e, i, s, n, r) {
        ...
        }), i.Tilemap = function(t, e, s, n, r, o) {
            this.game = t, this.key = e;
            var a = i.TilemapParser.parse(this.game, e, s, n, r, o);
            ...
            addTilesetImage: function(t, e, s, n, r, o, a) {
                ...
                if (null === l && this.format === i.Tilemap.TILED_JSON) return console.warn('Phaser.Tilemap.addTilesetImage: No data found in the JSON matching the tileset name: "' + t + '"'), console.log("Tilesets: ", this.tilesets), null;
                if (this.tilesets[l]) return this.tilesets[l].setImage(h), this.tilesets[l];
                var u = new i.Tileset(t, a, s, n, r, o, {});
                u.setImage(h), this.tilesets.push(u);
                for (var c = this.tilesets.length - 1, d = r, p = r, f = 0, g = 0, m = 0, y = a; y < a + u.total && (this.tiles[y] = [d, p, c], d += s + o, ++f !== u.total) && (++g !== u.columns || (d = r, p += n + o, g = 0, ++m !== u.rows)); y++);
                return u
            },
            createFromObjects: function(t, e, s, n, r, o, a, h, l, u) {
                if (void 0 === r && (r = !0), void 0 === o && (o = !1), void 0 === a && (a = this.game.world), void 0 === h && (h = i.Sprite), void 0 === l && (l = !0), void 0 === u && (u = !0), !this.objects[t]) return console.warn("Tilemap.createFromObjects: Invalid objectgroup name given: " + t), void console.log("Objects: ", this.objects);
                for (var c = 0; c < this.objects[t].length; c++) {
                    var d = !1,
                        p = this.objects[t][c];
                    if (void 0 !== p.gid && "number" == typeof e && p.gid === e ? d = !0 : void 0 !== p.id && "number" == typeof e && p.id === e ? d = !0 : void 0 !== p.name && "string" == typeof e && p.name === e && (d = !0), d) {
                        var f = new h(this.game, parseFloat(p.x, 10), parseFloat(p.y, 10), s, n);
                        f.name = p.name, f.autoCull = o, f.exists = r, f.visible = p.visible, u && (p.width && (f.width = p.width), p.height && (f.height = p.height)), p.rotation && (f.angle = p.rotation), l && (f.y -= f.height), a.add(f);
                        for (var g in p.properties) a.set(f, g, p.properties[g], !1, !1, 0, !0)
                    }
                }
            },
            createFromTiles: function(t, e, s, n, r, o) {
                "number" == typeof t && (t = [t]), void 0 === e || null === e ? e = [] : "number" == typeof e && (e = [e]), n = this.getLayer(n), void 0 === r && (r = this.game.world), void 0 === o && (o = {}), void 0 === o.customClass && (o.customClass = i.Sprite), void 0 === o.adjustY && (o.adjustY = !0);
                var a = this.layers[n].width,
                    h = this.layers[n].height;
                if (this.copy(0, 0, a, h, n), this._results.length < 2) return 0;
                for (var l, u = 0, c = 1, d = this._results.length; c < d; c++)
                    if (-1 !== t.indexOf(this._results[c].index)) {
                        l = new o.customClass(this.game, this._results[c].worldX, this._results[c].worldY, s);
                        for (var p in o) l[p] = o[p];
                        r.add(l), u++
                    }
                if (1 === e.length)
                    for (c = 0; c < t.length; c++) this.replace(t[c], e[0], 0, 0, a, h, n);
                else if (e.length > 1)
                    for (c = 0; c < t.length; c++) this.replace(t[c], e[c], 0, 0, a, h, n);
                return u
            },
            createLayer: function(t, e, s, n) {
                void 0 === e && (e = this.game.width), void 0 === s && (s = this.game.height), void 0 === n && (n = this.game.world);
                var r = t;
                if ("string" == typeof t && (r = this.getLayerIndex(t)), null === r || r > this.layers.length) return console.warn('Tilemap.createLayer: Invalid layer ID given: "' + t + '"'), void console.log("Layers: ", this.layers);
                ...
                var o = n.add(new i.TilemapLayer(this.game, this, r, e, s));
                return this.enableDebug && console.groupEnd(), o
            },
            createBlankLayer: function(t, e, s, n, r, o) {
                void 0 === o && (o = this.game.world); {
                    if (null === this.getLayerIndex(t)) {
                        for (var a, h = {
                                name: t,
                                x: 0,
                                y: 0,
                            ...
                            a = [];
                            for (var c = 0; c < e; c++) a.push(new i.Tile(h, -1, c, u, n, r));
                            l.push(a)
                        }
            ...
            getLayer: function(t) {
                if (void 0 === t) t = this.currentLayer;
                else if ("string" == typeof t) {
                    var e = t;
                    (t = this.getLayerIndex(t)) || console.warn("No such layer name: " + e)
                } else t instanceof i.TilemapLayer && (t = t.index);
                return t
            },
            ...
            n |= 0, r |= 0, i.Sprite.call(this, t, 0, 0), this.map = e, this.index = s, this.layer = e.layers[s], this.canvas = i.CanvasPool.create(this, n, r), this.context = this.canvas.getContext("2d"), this.setTexture(new PIXI.Texture(new PIXI.BaseTexture(this.canvas, null, this.game.resolution))), this.type = i.TILEMAPLAYER, this.physicsType = i.TILEMAPLAYER, this.renderSettings = {
                ...
                ch: e.tileHeight,
                tilesets: []
            }, this._scrollX = 0, this._scrollY = 0, this.tileOffset = new i.Point(this.layer.offsetX || 0, this.layer.offsetY || 0), this._results = [], t.device.canvasBitBltShift || (this.renderSettings.copyCanvas = i.TilemapLayer.ensureSharedCopyCanvas()), this.fixedToCamera = !0
            ...
            return this.sharedCopyCanvas || (this.sharedCopyCanvas = i.CanvasPool.create(this, 2, 2)), this.sharedCopyCanvas
            ...
            i.CanvasPool.remove(this), i.Component.Destroy.prototype.destroy.call(this)
        ...
        }, i.TilemapLayer.prototype.getTileOffsetX = function() {
            return this.tileOffset.x || (this.fixedToCamera ? 0 : this.position.x)
        }, i.TilemapLayer.prototype.getTileOffsetY = function() {
            ...
            for (var r = t.coordinatesOnLine(e), o = [], a = 0; a < n.length; a++)
                for (var h = 0; h < r.length; h++) {
                    var l = n[a],
                        u = r[h];
                    if (l.containsPoint(u[0], u[1])) {
                        o.push(l);
                        break
                    }
                }
            return o
        }, i.TilemapLayer.prototype.getTiles = function(t, e, i, s, n, r) {
            void 0 === n && (n = !1), void 0 === r && (r = !1);
            var o = !(n || r);
            t = this._fixX(t), e = this._fixY(e);
            for (var a = Math.floor(t / (this._mc.cw * this.scale.x)), h = Math.floor(e / (this._mc.ch * this.scale.y)), l = Math.ceil((t + i) / (this._mc.cw * this.scale.x)) - a, u = Math.ceil((e + s) / (this._mc.ch * this.scale.y)) - h; this._results.length;) this._results.pop();
            for (var c = h; c < h + u; c++)
                for (var d = a; d < a + l; d++) {
            ...
            var u = this.renderSettings.copyCanvas;
            if (u) {
                (u.width < n || u.height < r) && (u.width = n, u.height = r);
                var c = u.getContext("2d");
                c.clearRect(0, 0, n, r), c.drawImage(s, o, a, n, r, 0, 0, n, r), t.clearRect(h, l, n, r), t.drawImage(u, 0, 0, n, r, h, l, n, r)
            } else t.save(), t.globalCompositeOperation = "copy", t.drawImage(s, o, a, n, r, h, l, n, r), t.restore()
        }, i.TilemapLayer.prototype.renderRegion = function(t, e, i, s, n, r) {
            var o = this.context,
                a = this.layer.width,
                h = this.layer.height,
            ...
            var p, f, g, m, y, v, x = i * l - t,
                b = (i + (1 << 20) * a) % a;
            for (m = (s + (1 << 20) * h) % h, v = r - s, f = s * u - e; v >= 0; m++, v--, f += u) {
                m >= h && (m -= h);
                ...
                for (g = b, y = n - i, p = x; y >= 0; g++, y--, p += l) {
                    ...
                    if (T && !(T.index < 0)) {
                        var w = T.index,
                            C = c[w];
                        void 0 === C && (C = this.resolveTileset(w)), T.alpha === d || this.debug || (o.globalAlpha = T.alpha, d = T.alpha), C ? T.rotation || T.flipped ? (o.save(), o.translate(p + T.centerX, f + T.centerY), o.rotate(T.rotation), T.flipped && o.scale(-1, 1), C.draw(o, -T.centerX, -T.centerY, w), o.restore()) : C.draw(o, p, f, w) : this.debugSettings.missingImageFill && (o.fillStyle = this.debugSettings.missingImageFill, o.fillRect(p, f, l, u)), T.debug && this.debugSettings.debuggedTileOverfill && (o.fillStyle = this.debugSettings.debuggedTileOverfill, o.fillRect(p, f, l, u))
                    }
                }
            }
            ...
            var i = this._mc.scrollX,
                ...
                u = 0,
                c = -a;
            if (t < 0 ? (h = n + t, l = n - 1) : t > 0 && (l = t), e < 0 ? (u = r + e, c = r - 1) : e > 0 && (c = e), this.shiftCanvas(this.context, t, e), h = Math.floor((h + i) / o), l = Math.floor((l + i) / o), u = Math.floor((u + s) / a), c = Math.floor((c + s) / a), h <= l) {
            ...
            if (u <= c) {
                this.context.clearRect(0, u * a - s, n, (c - u + 1) * a);
                var f = Math.floor((0 + i) / o),
                    g = Math.floor((n - 1 + i) / o);
                this.renderRegion(i, s, f, u, g, c)
            }
            ...
            INSERT_NULL: !1,
            parse: function(t, e, s, n, r, o) {
                if (void 0 === s && (s = 32), void 0 === n && (n = 32), void 0 === r && (r = 10), void 0 === o && (o = 10), void 0 === e) return this.getEmptyData();
                if (null === e) return this.getEmptyData(s, n, r, o);
                var a = t.cache.getTilemapData(e);
                if (a) {
                    if (a.format === i.Tilemap.CSV) return this.parseCSV(e, a.data, s, n);
            ...
            parseCSV: function(t, e, s, n) {
                for (var r = this.getEmptyData(), o = [], a = (e = e.trim()).split("\n"), h = a.length, l = 0, u = 0; u < a.length; u++) {
                    o[u] = [];
                    for (var c = a[u].split(","), d = 0; d < c.length; d++) o[u][d] = new i.Tile(r.layers[0], parseInt(c[d], 10), d, u, s, n);
                    0 === l && (l = c.length)
                }
                return r.format = i.Tilemap.CSV, r.name = t, r.width = l, r.height = h, r.tileWidth = s, r.tileHeight = n, r.widthInPixels = l * s, r.heightInPixels = h * n, r.layers[0].width = l, r.layers[0].height = h, r.layers[0].widthInPixels = r.widthInPixels, r.layers[0].heightInPixels = r.heightInPixels, r.layers[0].data = o, r
            },
            ...
            parseObjectGroup: function(t, e, i, s, n) {
                ...
                for (var o = 0, a = t.objects.length; o < a; o++) {
                    ...
                    if (h.gid) {
                        ...
                        for (u = 0; u < h.polyline.length; u++) l.polyline.push([h.polyline[u].x, h.polyline[u].y]);
                        i[s].push(l), e[s].push(l)
                    } else if (h.polygon) {
                        (l = r(h, ["name", "type", "x", "y", "visible", "rotation", "properties"])).x += n.x, l.y += n.y, l.polygon = [];
                        for (var u = 0; u < h.polygon.length; u++) l.polygon.push([h.polygon[u].x, h.polygon[u].y]);
                        i[s].push(l), e[s].push(l)
            ...
            parseTiledJSON: function(t) {
                ...
                for (var e = {
                    ...
                    if ("tilelayer" === t.layers[n].type) {
                        ...
                        r.properties && (D.properties = r.properties);
                        for (var u, c, d, p = 0, f = [], g = [], m = 0, a = r.data.length; m < a; m++) {
                            if (u = 0, c = !1, E = r.data[m], d = 0, E > 536870912) switch (E > 2147483648 && (E -= 2147483648, d += 4), E > 1073741824 && (E -= 1073741824, d += 2), E > 536870912 && (E -= 536870912, d += 1), d) {
                                case 5:
                                    u = Math.PI / 2;
                                    break;
                                case 6:
                            ...
                            E > 0 ? ((F = new i.Tile(D, E, p, g.length, t.tilewidth, t.tileheight)).rotation = u, F.flipped = c, 0 !== d && (F.flippedVal = d), f.push(F)) : i.TilemapParser.INSERT_NULL ? f.push(null) : f.push(new i.Tile(D, -1, p, g.length, t.tilewidth, t.tileheight)), ++p === r.width && (g.push(f), p = 0, f = [])
                        }
                        D.data = g, s.push(D)
                    }
                e.layers = s;
                for (var y = [], n = 0; n < t.layers.length; n++)
                ...
                e.images = y;
                for (var b = [], _ = {}, T = [], w = null, n = 0; n < t.tilesets.length; n++) {
                    if ((U = t.tilesets[n]).source) console.warn("Phaser.TilemapParser - Phaser can't load external tilesets (%s). Use the Embed Tileset button and then export the map again.", U.source);
                    else if (U.image) {
                        var C = new i.Tileset(U.name, U.firstgid, U.tilewidth, U.tileheight, U.margin, U.spacing, U.properties);
                        U.tileproperties && (C.tileProperties = U.tileproperties), C.updateTileData(U.imagewidth, U.imageheight), b.push(C)
                    } else {
                        if (!U.tiles) throw new Error("Tileset " + U.name + " has no `image` or `tiles` property.");
                        var S = new i.ImageCollection(U.name, U.firstgid, U.tilewidth, U.tileheight, U.margin, U.spacing, U.properties);
                        for (var P in U.tiles) {
                            var x = U.tiles[P].image,
                                E = U.firstgid + parseInt(P, 10);
                            S.addImage(E, x)
                        }
                        T.push(S)
                    }
                    for (var P in U.tiles)(R = U.tiles[P].objectgroup) && (_[parseInt(P, 10) + U.firstgid] = R);
                    w && (w.lastgid = U.firstgid - 1), w = U
                }
                if (0 === b.length && 0 === T.length) throw new Error("This tilemap has no tilesets.");
                e.tilesets = b, e.imagecollections = T;
                for (var A = {}, M = {}, n = 0; n < t.layers.length; n++)
                    if ("objectgroup" === t.layers[n].type) {
                        var R = t.layers[n];
                        this.parseObjectGroup(R, A, M)
                    }
                e.objects = A, e.collision = M, e.tiles = [];
                for (n = 0; n < e.tilesets.length; n++)
                    for (var p = (U = e.tilesets[n]).tileMargin, L = U.tileMargin, O = 0, I = 0, k = 0, m = U.firstgid; m < U.firstgid + U.total && (e.tiles[m] = [p, L, n], p += U.tileWidth + U.tileSpacing, ++O !== U.total) && (++I !== U.columns || (p = U.tileMargin, L += U.tileHeight + U.tileSpacing, I = 0, ++k !== U.rows)); m++);
                for (var D, F, B, U, n = 0; n < e.layers.length; n++) {
                    M[(D = e.layers[n]).name] = [], U = null;
                    for (l = 0; l < D.data.length; l++) {
                        f = D.data[l];
                        for (var G = 0; G < f.length; G++) null === (F = f[G]) || F.index < 0 || (B = e.tiles[F.index][2], (U = e.tilesets[B]).tileProperties && U.tileProperties[F.index - U.firstgid] && (F.properties = i.Utils.mixin(U.tileProperties[F.index - U.firstgid], F.properties)), (R = _[F.index]) && this.parseObjectGroup(R, e.objects, e.collision, F.layer.name, {
                            x: F.worldX + R.x,
                            y: F.worldY + R.y
                        }))
                    }
        ...
        }, i.Tileset.prototype.constructor = i.Tileset, i.Particle = function(t, e, s, n, r) {
            i.Sprite.call(this, t, e, s, n, r), this.autoScale = !1, this.scaleData = null, this._s = 0, this.autoAlpha = !1, this.alphaData = null, this._a = 0
            ...
            this.maxParticles = n || 50, i.Group.call(this, t), this._id = this.game.particles.ID++, this.name = "emitter" + this.id, this.type = i.EMITTER, this.physicsType = i.GROUP, this.area = new i.Rectangle(e, s, 1, 1), this.minAngle = null, this.maxAngle = null, this.minSpeed = 0, this.maxSpeed = 100, this.minParticleSpeed = new i.Point(-100, -100), this.maxParticleSpeed = new i.Point(100, 100), this.minParticleScale = 1, this.maxParticleScale = 1, this.scaleData = null, this.minRotation = -360, this.maxRotation = 360, this.minParticleAlpha = 1, this.maxParticleAlpha = 1, this.alphaData = null, this.particleClass = i.Particle, this.particleDrag = new i.Point, this.angularDrag = 0, this.frequency = 100, this.lifespan = 2e3, this.bounce = new i.Point, this.on = !1, this.particleAnchor = new i.Point(.5, .5), this.blendMode = i.blendModes.NORMAL, this.emitX = e, this.emitY = s, this.autoScale = !1, this.autoAlpha = !1, this.particleBringToTop = !1, this.particleSendToBack = !1, this.counts = {
                emitted: 0,
                failed: 0,
                totalEmitted: 0,
                totalFailed: 0
            }, this._gravity = new i.Point(0, 100), this._minParticleScale = new i.Point(1, 1), this._maxParticleScale = new i.Point(1, 1), this._total = 0, this._timer = 0, this._counter = 0, this._flowQuantity = 0, this._flowTotal = 0, this._explode = !0, this._frames = null
        ...
        }, i.Particles.Arcade.Emitter.prototype.makeParticles = function(t, e, i, s, n, r) {
            ...
            return void 0 !== e && null !== e || (e = 250), void 0 !== i && 0 !== i || (i = 1), void 0 === s && (s = -1), void 0 === n && (n = !0), i > this.maxParticles && (i = this.maxParticles), this._counter = 0, this._flowQuantity = i, this._flowTotal = s, n ? (this.start(!0, t, e, i), this._counter += i, this.on = !0, this._timer = this.game.time.time + e * this.game.time.slowMotion) : this.start(!1, t, e, i), this
        ...
        }, i.Particles.Arcade.Emitter.prototype.getNextParticle = function() {
            for (var t = this.length; t--;) {
                var e = this.next();
                if (!e.exists) return e
            }
            return null
        }, i.Particles.Arcade.Emitter.prototype.resetParticle = function(t, e, i) {
            var s = this.game.rnd;
        ...
        }, i.Particles.Arcade.Emitter.prototype.setAlpha = function(t, e, s, n, r) {
            if (void 0 === t && (t = 1), void 0 === e && (e = 1), void 0 === s && (s = 0), void 0 === n && (n = i.Easing.Linear.None), void 0 === r && (r = !1), this.minParticleAlpha = t, this.maxParticleAlpha = e, this.autoAlpha = !1, s > 0 && t !== e) {
                var o = {
                        v: t
                    },
            ...
            return this
        }, i.Particles.Arcade.Emitter.prototype.setScale = function(t, e, s, n, r, o, a) {
            if (void 0 === t && (t = 1), void 0 === e && (e = 1), void 0 === s && (s = 1), void 0 === n && (n = 1), void 0 === r && (r = 0), void 0 === o && (o = i.Easing.Linear.None), void 0 === a && (a = !1), this.minParticleScale = 1, this.maxParticleScale = 1, this._minParticleScale.set(t, s), this._maxParticleScale.set(e, n), this.autoScale = !1, r > 0 && (t !== e || s !== n)) {
                var h = {
                        x: t,
                        y: s
                    },
            ...
            return this
        }, i.Particles.Arcade.Emitter.prototype.setAngle = function(t, e, i, s) {
        ...
        }, Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "gravity", {
            get: function() {
        ...
        }), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "id", {
            get: function() {
                return this._id
            }
        ...
        }), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "output", {
            get: function() {
                return 1e3 * this._flowQuantity / this.frequency
            }
        }), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "lifespanOutput", {
            get: function() {
                return (0 === this.lifespan ? 1 / 0 : this.lifespan) * this._flowQuantity / this.frequency
            }
        }), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "remainder", {
            get: function() {
            ...
            i.Plugin.call(this, t, e), this.bullets = null, this.autoExpandBulletsGroup = !1, this.autofire = !1, this.shots = 0, this.fireLimit = 0, this.fireRate = 100, this.fireRateVariance = 0, this.fireFrom = new i.Rectangle(0, 0, 1, 1), this.fireAngle = i.ANGLE_UP, this.bulletInheritSpriteSpeed = !1, this.bulletAnimation = "", this.bulletFrameRandom = !1, this.bulletFrameCycle = !1, this.bulletWorldWrap = !1, this.bulletWorldWrapPadding = 0, this.bulletAngleOffset = 0, this.bulletAngleVariance = 0, this.bulletSpeed = 200, this.bulletSpeedVariance = 0, this.bulletLifespan = 0, this.bulletKillDistance = 0, this.bulletGravity = new i.Point(0, 0), this.bulletRotateToVelocity = !1, this.bulletKey = "", this.bulletFrame = "", this._bulletClass = i.Bullet, this._bulletCollideWorldBounds = !1, this._bulletKillType = i.Weapon.KILL_WORLD_BOUNDS, this._data = {
                ...
                offsetX: 0,
                offsetY: 0
            }, this.bounds = new i.Rectangle, this.bulletBounds = t.world.bounds, this.bulletFrames = [], this.bulletFrameIndex = 0, this.anims = {}, this.onFire = new i.Signal, this.onKill = new i.Signal, this.onFireLimit = new i.Signal, this.trackedSprite = null, this.trackedPointer = null, this.multiFire = !1, this._hasFired = !1, this.trackRotation = !1, this.trackOffset = new i.Point, this._nextFire = 0, this._tempNextFire = 0, this._rotatedPoint = new i.Point
        ...
        }, i.Weapon.prototype.postRender = function() {
        ...
        }, i.Weapon.prototype.fireMany = function(t, e) {
            this.multiFire = !0;
            var i = [],
                s = this;
            ...
            null !== e && null !== s && (l = this.game.math.radToDeg(Math.atan2(s - h, e - a))), 0 !== this.bulletAngleVariance && (l += i.Math.between(-this.bulletAngleVariance, this.bulletAngleVariance));
            var u = 0,
                c = 0;
            0 === l || 180 === l ? u = Math.cos(this.game.math.degToRad(l)) * o : 90 === l || 270 === l ? c = Math.sin(this.game.math.degToRad(l)) * o : (u = Math.cos(this.game.math.degToRad(l)) * o, c = Math.sin(this.game.math.degToRad(l)) * o);
            var d = null;
            if (this.autoExpandBulletsGroup ? (d = this.bullets.getFirstExists(!1, !0, a, h, this.bulletKey, this.bulletFrame)).data.bulletManager = this : d = this.bullets.getFirstExists(!1), d) {
                ...
                d.data.bodyDirty && (this._data.customBody && d.body.setSize(this._data.width, this._data.height, this._data.offsetX, this._data.offsetY), d.body.collideWorldBounds = this.bulletCollideWorldBounds, d.data.bodyDirty = !1), d.body.velocity.set(u, c), d.body.gravity.set(this.bulletGravity.x, this.bulletGravity.y);
                var f = 0;
                if (0 !== this.bulletSpeedVariance) {
                    var g = this.fireRate;
                    (g += i.Math.between(-this.fireRateVariance, this.fireRateVariance)) < 0 && (g = 0), f = this.game.time.now + g
        ...
        }), i.Bullet = function(t, e, s, n, r) {
            i.Sprite.call(this, t, e, s, n, r), this.anchor.set(.5), this.data = {
                bulletManager: null,
                fromX: 0,
                fromY: 0,
                bodyDirty: !0,
            ...
            this.video && !s ? (this.baseTexture = new PIXI.BaseTexture(this.video, null, this.game.resolution), this.baseTexture.forceLoaded(this.width, this.height)) : (this.baseTexture = new PIXI.BaseTexture(i.Cache.DEFAULT.baseTexture.source, null, this.game.resolution), this.baseTexture.forceLoaded(this.width, this.height)), this.texture = new PIXI.Texture(this.baseTexture), this.textureFrame = new i.Frame(0, 0, 0, this.width, this.height, "video"), this.texture.setFrame(this.textureFrame), this.texture.valid = !1, null !== e && this.video && (this.texture.valid = this.video.canplay), this.snapshot = null, i.BitmapData && (this.snapshot = new i.BitmapData(this.game, "", this.width, this.height)), this.game.device.needsTouchUnlock() ? this.setTouchLock() : n && (n.locked = !1)
        }, i.Video.prototype = {
        ...
        }), i.Video.prototype.constructor = i.Video, void 0 === PIXI.blendModes && (PIXI.blendModes = i.blendModes), void 0 === PIXI.scaleModes && (PIXI.scaleModes = i.scaleModes), void 0 === PIXI.Texture.emptyTexture && (PIXI.Texture.emptyTexture = new PIXI.Texture(new PIXI.BaseTexture)), void 0 === PIXI.DisplayObject._tempMatrix && (PIXI.DisplayObject._tempMatrix = new i.Matrix), PIXI.TextureSilentFail = !0, PIXI.canUseNewCanvasBlendModes = function() {
